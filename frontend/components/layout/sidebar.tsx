...
import {
  ...
  Repeat, BookOpen as Journal, FileText, Library, Layers, Sparkles,
  BarChart3, Settings, Star, Archive, X, ChevronsLeft, ChevronsRight,
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/flashcards", label: "Flashcards", icon: Layers, badge: "flashcards" },
