...
import { Sun, Calendar, CheckSquare, Repeat, Target, Timer } from "lucide-react";
...
export default function HojePage() {
  ...
  const summary = `Hoje tens ${data.tasks_today.length} tarefas e ${data.events_today.length} eventos.`;
